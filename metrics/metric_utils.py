...
def feature_prediction(train_data, test_data, index,max_length):
...
def one_step_ahead_prediction(train_data, test_data,max_length):
    ...
    args["max_seq_len"] = max_length   # only 99 is used for prediction
    args["learning_rate"] = 1e-3
    args["grad_clip_norm"] = 5.0
